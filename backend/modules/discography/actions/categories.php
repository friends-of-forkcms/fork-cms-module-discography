 ...
 */
class BackendDiscographyCategories extends BackendBaseActionIndex
{
	/**
	 * Execute the action
	 */
	...
	{
		// create datagrid
		$this->dataGrid = new BackendDataGridDB(BackendDiscographyModel::QRY_DATAGRID_BROWSE_CATEGORIES);
